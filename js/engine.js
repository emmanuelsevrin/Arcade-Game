...
var Engine = (function(global) {
    ...
    function request_hero_selection(){
        ...
        //set of heroes the player can choose from
        var hero_set=[
            'images/char-boy.png',
    ...
    document.addEventListener('keyup', function(e) {
        ...
        var allowedKeys_selection ={
           49: 'one',
           50: 'two',
           51: 'three',
           52: 'four',
        }       
        if((character_defined === 0) && (allowedKeys_selection[e.keyCode] !== undefined)){
            character_defined = 1;
            selectcharacter(allowedKeys_selection[e.keyCode]);
        }
        if(allowedKeys_move[e.keyCode] !== undefined){
            player.handleInput(allowedKeys_move[e.keyCode]);
        }
    });
